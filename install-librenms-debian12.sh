...
#
#  Uso:
#    sudo bash install-librenms-debian12.sh
#    sudo BASE_URL=http://1.2.3.4:8087 ADMIN_EMAIL=tu@correo bash install-librenms-debian12.sh
#
...
=================================================================
  ...
  Instalador:         install-librenms-debian12.sh v${INSTALLER_VERSION}
